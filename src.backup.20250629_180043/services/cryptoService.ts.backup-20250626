import { CryptoRepository, XMoneyOrder, CryptoTransaction } from '../repositories/cryptoRepository';
...
export class CryptoService {
  ...
  static async getDepositHistory(
    ...
    try {
      ...
      const { transactions, total } = await CryptoRepository.getUserDepositHistory(userId, {
        ...filters,
        limit,
        offset
      });
