 ...
 * @access Private
 */
router.get('/upcoming-renewal', authenticate, TierController.getUpcomingRenewal);
 ...
 * @access Private
 */
router.get('/monthly-fee-breakdown', authenticate, TierController.getMonthlyFeeBreakdown);
